...
// Fetch River spots from Bangladesh
...
$stmt->execute(['country' => 'Bangladesh', 'type' => 'River']);
$spots = $stmt->fetchAll(PDO::FETCH_ASSOC);
$page_title = "River & Lake Destinations";
$current_page_identifier = "river";
?>
...
<body>
    ...
    <section class="hero-spots" style="padding: 20px;">
        ...
        <div id="spots-list" class="hotel-grid">
            <?php if (empty($spots)): ?>
                <p style="text-align:center;">No river or lake destinations available in Bangladesh at the moment.</p>
            <?php else: ?>

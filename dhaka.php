...
$division_name = "Dhaka"; // Specific for this file
$current_page_identifier = "dhaka"; // Specific for this file

// Fetch all spots in the specified division
$sql = "SELECT spot_id, name, type, division, location, image_url FROM tourist_spots WHERE country = :country AND division = :division ORDER BY name ASC";
$stmt = $conn->prepare($sql);
$stmt->execute(['country' => 'Bangladesh', 'division' => $division_name]);
$spots = $stmt->fetchAll(PDO::FETCH_ASSOC);
$page_title = "Tourist Spots in " . $division_name;
?>
...
<head>
    ...
    <link rel="stylesheet" href="CSS/destination.css"> <link rel="stylesheet" href="CSS/hotel_styles_v2.css"> <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
</head>
<body>
    <?php include 'navbar.php'; ?>

    <section class="hero-spots" style="padding: 20px;">
        <h2 style="text-align:center; margin-bottom: 10px;"><?php echo $page_title; ?></h2>
        ...
        <div id="spots-list" class="hotel-grid"> <?php if (empty($spots)): ?>
                <p style="text-align:center;">No tourist spots available in <?php echo htmlspecialchars($division_name); ?> at the moment.</p>
            <?php else: ?>

...
// Fetch Sea spots from Bangladesh
// Added spot_id, name, type, division, location, image_url to be specific
...
$stmt->execute(['country' => 'Bangladesh', 'type' => 'Sea']);
$spots = $stmt->fetchAll(PDO::FETCH_ASSOC);
$page_title = "Sea Destinations";
$current_page_identifier = "sea"; // For add_to_wishlist redirection
?>
...
<body>
    ...
    <section class="hero-spots" style="padding: 20px;">
        ...
        <div id="spots-list" class="hotel-grid"> <?php if (empty($spots)): ?>
                <p style="text-align:center;">No <?php echo strtolower(explode(" ", $page_title)[0]); ?> destinations available in Bangladesh at the moment.</p>
            <?php else: ?>

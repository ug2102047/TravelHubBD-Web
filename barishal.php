...
$division_name = "Barisal"; // Specific for this file (Note: DB might store as "Barisal" or "Barishal")
$current_page_identifier = "barishal"; // Specific for this file
...
// Use the exact division name as stored in your database. If it's "Barisal", use that.
$stmt->execute(['country' => 'Bangladesh', 'division' => $division_name]); // Or 'Barishal' if that's in DB

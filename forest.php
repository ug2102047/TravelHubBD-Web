...
// Fetch Forest spots from Bangladesh
...
$stmt->execute(['country' => 'Bangladesh', 'type' => 'Forest']);
$spots = $stmt->fetchAll(PDO::FETCH_ASSOC);
$page_title = "Forest Destinations";
$current_page_identifier = "forest";
?>
...
<body>
    ...
    <section class="hero-spots" style="padding: 20px;">
        ...
        <div id="spots-list" class="hotel-grid">
            <?php if (empty($spots)): ?>
                <p style="text-align:center;">No forest destinations available in Bangladesh at the moment.</p>
            <?php else: ?>

...
// Fetch Historical spots from Bangladesh
...
$stmt->execute(['country' => 'Bangladesh', 'type' => 'Historical']);
$spots = $stmt->fetchAll(PDO::FETCH_ASSOC);
$page_title = "Historical Destinations";
$current_page_identifier = "historical_places";
?>
...
<body>
    ...
    <section class="hero-spots" style="padding: 20px;">
        ...
        <div id="spots-list" class="hotel-grid">
            <?php if (empty($spots)): ?>
                <p style="text-align:center;">No historical destinations available in Bangladesh at the moment.</p>
            <?php else: ?>

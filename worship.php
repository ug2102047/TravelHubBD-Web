...
// Fetch Worship spots from Bangladesh
...
$stmt->execute(['country' => 'Bangladesh', 'type' => 'Worship']);
$spots = $stmt->fetchAll(PDO::FETCH_ASSOC);
$page_title = "Places of Worship";
$current_page_identifier = "worship";
?>
...
<body>
    ...
    <section class="hero-spots" style="padding: 20px;">
        ...
        <div id="spots-list" class="hotel-grid">
            <?php if (empty($spots)): ?>
                <p style="text-align:center;">No places of worship available in Bangladesh at the moment.</p>
            <?php else: ?>
